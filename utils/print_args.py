...
def save_args(args, f=None):
    ...
    f.write(f'  {"Checkpoints:":<20}{args.checkpoints:<20}\n')
    f.write('\n')
    ...
    f.write(f'  {"n heads:":<20}{args.n_heads:<20}{"e layers:":<20}{args.e_layers:<20}\n')
    f.write(f'  {"d layers:":<20}{args.d_layers:<20}{"d FF:":<20}{args.d_ff:<20}\n')
    f.write(f'  {"Moving Avg:":<20}{args.moving_avg:<20}{"Factor:":<20}{args.factor:<20}\n')
    f.write(f'  {"Distil:":<20}{args.distil:<20}{"Dropout:":<20}{args.dropout:<20}\n')
